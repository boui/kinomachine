...
import com.kinomachine.MainGuiceModule;
import com.kinomachine.rest.RestService;
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        injector =  Guice.createInjector(new ServletModule(){
            ...
            protected void configureServlets() {
                ...
                parameters.put("com.sun.jersey.config.property.JSPTemplatesBasePath","/WEB-INF/pages");

                serve("/app/*").with(GuiceContainer.class, parameters);
            }
        }, new MainGuiceModule());
